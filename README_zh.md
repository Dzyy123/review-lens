...
AI 辅助审稿已经**势不可挡——它就是 peer review 未来的趋势**。NeurIPS / ICML 2026 都已开了官方通道，研究也证明**用得对**的 AI 反馈能提升 review。而真正的现实是：**无论会议允许还是禁止，越来越多的人已经在用了。** 这瓶盖一旦打开就盖不回去。

于是，一份 review 的两端都被推进了同一个两难：

- 🧑‍⚖️ **审稿人** —— AI 很诱人（有时还被官方允许），但一键生成的 review 往往注水、跑题、甚至违反政策。怎么**用得好**、又**合规**？
- 🧑‍🔬 **作者** —— 你成了 AI 注水 review 的承受方，而且**无论意见多离谱，你都得逐条回应。**

review 里的"水分"通常是这几种形态：
...
现有的 AI-for-review 工具几乎都在 **帮人写 review** 或 **帮作者改稿** —— 没有一个解决上面这个两难。

> 🎯 **问题已经不是"该不该在审稿里用 AI"，而是"既然大家已经在用了——无论允许与否——作者和审稿人该怎么办？" 这就是 ReviewLens 的起点，而下面的一切都是答案。**
